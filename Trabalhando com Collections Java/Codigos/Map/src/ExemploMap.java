...
public class ExemploMap {
    public static void main(String[] args) {
        ...
        System.out.println("Substitua o consumo do gol para 15.2 km/L: ");
        carrosPopulares.put("gol",15.2);
        System.out.println(carrosPopulares);

        System.out.println("Confira se o modelo tucson esta no dicionario: "+ carrosPopulares.containsKey("tucson"));

        System.out.println("Exiba o consumo do unio:"+ carrosPopulares.get("uno"));
        ...
        System.out.println("Exiba o modelo menos econonomico e seu consumo: ");
